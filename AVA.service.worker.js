...
/** @type {string} */
const CACHE_VERSION = '1777023945|76782679715';
/** @type {string} */
const CACHE_PREFIX = 'New Gamejam 2026-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'AVA.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["AVA.html","AVA.js","AVA.offline.html","AVA.icon.png","AVA.apple-touch-icon.png","AVA.audio.worklet.js","AVA.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["AVA.wasm","AVA.pck"];
